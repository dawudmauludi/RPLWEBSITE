    ...
    <div class="container mx-auto p-6">
        <div class="bg-white rounded-xl shadow-lg border border-purple-100 p-6 mb-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <a href="{{ route('siswa.karya.create') }}"
            ...
            <form method="GET" action="{{ route('siswa.karya.index') }}" class="flex flex-col sm:flex-row gap-4 mt-4">
                            ...
                            <tr class="hover:bg-purple-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-3">
                                        <a href="{{ route('siswa.karya.edit', $karya) }}"
                                        ...
                                        <form action="{{ route('siswa.karya.destroy', $karya->id) }}" method="POST" class="inline" onsubmit="return confirmDelete(event)">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
