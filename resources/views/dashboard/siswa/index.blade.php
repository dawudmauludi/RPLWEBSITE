                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-indigo-500 hover:shadow-xl transition-shadow duration-300">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600">Ulangan kelas saya</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                        ...
                        <div class="p-6">
                            @if($karyaSaya->isEmpty())
                                <div class="flex flex-col items-center justify-center py-8 bg-gray-50 rounded-lg shadow-md">
                                    <div class="p-4 bg-purple-100 rounded-full">
                                        <i data-feather="file-plus" class="w-10 h-10 text-purple-600"></i>
                                    </div>
                                    <p class="mt-4 text-gray-500">Belum ada karya yang dibuat</p>
                                    <a href="{{ route('siswa.karya.create') }}" class="mt-5 px-6 py-3 bg-purple-600 text-white rounded-full hover:bg-purple-700 transition duration-300 ease-in-out transform hover:scale-105">
                                        <i data-feather="plus" class="w-5 h-5 inline mr-2"></i>Buat Karya Baru
                                    </a>
                                </div>
                            @else
