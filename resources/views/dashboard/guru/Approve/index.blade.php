        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center space-x-3 mb-2">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900">Persetujuan User</h1>
                </div>
                <p class="text-gray-600">Kelola dan setujui pendaftaran user baru untuk mengakses sistem</p>
            </div>
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-sm text-gray-500">Filter & Kelola</span>
                        </div>
                    </div>
                </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    @if(!$user->is_approved)
                                        <div class="flex items-center space-x-3">
                                            <form action="{{ route('guru.user.approve', $user->id) }}" method="POST" class="inline">
                                                @csrf
                                            ...
                                            <form action="{{ route('guru.user.reject', $user->id) }}" method="POST" class="inline">
                                                @csrf
                                                <button type="submit" class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg shadow-sm transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    @else
                                        <div class="flex items-center text-gray-500">
                                            ...
                                            <span class="text-sm">Sudah disetujui</span>
                                        </div>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="3" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 text-lg font-medium">Tidak ada user yang menunggu persetujuan</p>
                                        <p class="text-gray-400 text-sm mt-1">Semua user telah diproses atau belum ada pendaftaran baru</p>
                                    </div>
                                </td>
                            </tr>
                            @endif
