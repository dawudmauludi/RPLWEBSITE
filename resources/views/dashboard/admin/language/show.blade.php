        ...
        <div class="container mx-auto px-6">
            <div class="max-w-4xl mx-auto text-center">
                <div class="inline-flex items-center bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm mb-6">
                    ...
                    <span data-aos="fade-right" data-aos-duration="1600" class="text-purple-700 font-medium">{{$language->slug}}</span>
                </div>
                ...
                <div data-aos="zoom-in" data-aos-duration="1600" class="relative mx-auto max-w-2xl flex items-center justify-center">
                    ...
                    <img
                        ...
                        alt="{{ $language->name }}"
                        class="relative rounded-2xl shadow-2xl w-1/2 h-auto object-cover filter drop-shadow-[0_10px_10px_rgba(0,0,0,0.25)]"
                    >
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-6">
            <div class="max-w-4xl mx-auto">
                <div class="flex items-center mb-8">
                    ...
                    <h2 data-aos="fade-right" data-aos-duration="1600" class="text-3xl font-bold text-gray-900">Tentang Mapel {{ $language->name }}</h2>
                </div>
