    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-lg border border-purple-100 p-6 mb-6">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">{{ isset($language) ? 'Edit language' : 'Tambah language' }}</h1>
                    <p class="text-gray-600 text-sm">{{ isset($language) ? 'Perbarui informasi language' : 'Buat language baru untuk dipublikasikan' }}</p>
                </div>
            </div>
        </div>
        <div class="grid gap-6">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-purple-100 p-6">
                ...
                <div class="grid gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text"
                               name="name"
                               placeholder="Masukkan name language..."
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text"
                               name="icon"
                               placeholder="Masukkan nama icon dari data feather yang sesuai..."
            ...
            <div class="bg-white rounded-xl shadow-lg border border-purple-100 p-6">
                <div class="flex items-center mb-6">
                    ...
                    <h2 class="text-lg font-semibold text-gray-800">Konten language</h2>
                </div>
                ...
                <div class="grid gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input id="description" type="hidden" name="description" value="{{ old('description', $language->description ?? '') }}">
                        <trix-editor input="description"
                                    placeholder="Tulis description language lengkap di sini..."
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex gap-3 flex-wrap">
                                <div class="relative group">
                                    <img src="{{ asset('storage/' . $language->image) }}"
                                         alt="Gambar language"
            ...
            <div class="flex justify-between items-center mt-4">
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded shadow-md transition-all">
                     <span>{{ isset($language) ? 'Update Data' : 'Simpan Data' }}</span>
                </button>
                <a href="{{ route('admin.language.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-6 rounded shadow-sm transition-all">
                    Kembali
                </a>
            </div>
        </div>
...
<script>
document.addEventListener('DOMContentLoaded', function () {
    const judulInput = document.querySelector('input[name="name"]');
    const slugInput = document.querySelector('input[name="slug"]');
    const isiInput = document.querySelector('input[name="description"]');
