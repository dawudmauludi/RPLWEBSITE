    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6 border-t-4 border-purple-500">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-2">Kelola data alumni sekolah</p>
            </div>
            ...
            <div class="mt-6">
            <form method="GET" action="{{ route('admin.alumni.index') }}" id="searchForm" autocomplete="off">
                <div class="relative">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full" id="alumniTable">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @foreach($alumni as $s)
                            <tr class="hover:bg-purple-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('admin.alumni.show', $s->id) }}"
                                        ...
                                        <a href="{{ route('admin.alumni.edit', $s->id) }}"
                                        ...
                                        <form action="{{ route('admin.alumni.destroy', $s->id) }}" method="POST" class="inline delete-form">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
            ...
            @if($alumni->isEmpty())
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada data alumni</h3>
                    <p class="text-gray-500 mb-4">Mulai dengan menambahkan alumni baru</p>
                    <a href="{{ route('admin.alumni.create') }}"
...
document.getElementById('searchInput').addEventListener('input', function() {
    ...
    this.delay = setTimeout(() => {
        fetch(`{{ route('admin.alumni.index') }}?search=${encodeURIComponent(this.value)}`, {
            headers: {
        ...
        .then(html => {
            ...
            const newTable = doc.querySelector('#alumniTable').innerHTML;
            document.querySelector('#alumniTable').innerHTML = newTable;
