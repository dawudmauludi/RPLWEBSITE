        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6 border-t-4 border-purple-500">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Informasi lengkap data alumni</p>
                </div>
                <div class="flex gap-3">
                    ...
                    <form id="form-hapus-alumni" action="{{ route('admin.alumni.destroy', $alumni->id) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
                        <button type="button"
                            onclick="hapusalumniConfirm()"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-lg p-6 text-center">
                    ...
                    <h2 class="text-xl font-bold text-gray-800 mb-2">{{ $alumni->nama }}</h2>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-800 font-semibold">{{ $alumni->nama }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-800 font-semibold">{{ $alumni->nisn }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-800 font-semibold">{{ $alumni->agama }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-800 font-semibold">
                                            @if($alumni->tanggal_lahir)
                                                {{ \Carbon\Carbon::parse($alumni->tanggal_lahir)->format('d F Y') }}
                                                <span class="text-sm text-gray-500 ml-2">
                                                    ({{ \Carbon\Carbon::parse($alumni->tanggal_lahir)->age }} tahun)
                                                </span>
                                            @else
                                                -
                                            @endif
                                ...
                                <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-500 mb-1">Tahun Lulus</p>
                                        <p class="text-gray-800 font-semibold">{{ $alumni->tahun_lulus }}</p>
                                    </div>
                                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="flex items-center gap-3 p-4 bg-purple-50 rounded-lg border border-purple-200">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-purple-600">{{ $alumni->user->email }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-green-50 rounded-lg border border-green-200">
                            ...
                            <div>
                                ...
                                <p class="text-green-900 font-semibold">
                                    {{ \Carbon\Carbon::parse($alumni->created_at)->format('d M Y') }}
                                </p>
                                <p class="text-xs text-green-600">
                                    {{ \Carbon\Carbon::parse($alumni->created_at)->diffForHumans() }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
                            ...
                            <div>
                                ...
                                <p class="text-blue-900 font-semibold">
                                    {{ \Carbon\Carbon::parse($alumni->updated_at)->format('d M Y') }}
                                </p>
...
function hapusalumniConfirm() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            document.getElementById('form-hapus-alumni').submit();
        }
    });
}
</script>
...
@if($alumni->foto)
document.querySelector('img[alt="Foto {{ $alumni->nama }}"]').addEventListener('click', function() {
