    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-lg border border-purple-100 p-6 mb-6">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">{{ isset($career) ? 'Edit career' : 'Tambah career' }}</h1>
                    <p class="text-gray-600 text-sm">{{ isset($career) ? 'Perbarui informasi career' : 'Buat career baru untuk dipublikasikan' }}</p>
                </div>
            </div>
        </div>
        <div class="grid gap-6">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-purple-100 p-6">
                ...
                <div class="grid gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text"
                               name="name"
                               placeholder="Masukkan name career..."
            ...
            <div class="bg-white rounded-xl shadow-lg border border-purple-100 p-6">
                <div class="flex items-center mb-6">
                    ...
                    <h2 class="text-lg font-semibold text-gray-800">Konten career</h2>
                </div>
                ...
                <div class="grid gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <trix-editor input="description"
                                    placeholder="Tulis description career lengkap di sini..."
            ...
            <div class="flex justify-between items-center mt-4">
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded shadow-md transition-all">
                     <span>{{ isset($career) ? 'Update Data' : 'Simpan Data' }}</span>
                </button>
                <a href="{{ route('admin.career.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-6 rounded shadow-sm transition-all">
                    Kembali
                </a>
            </div>
        </div>
