    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="bg-gradient-to-r from-purple-600 to-indigo-600 px-8 py-6">
                ...
                <p class="text-purple-100 mt-2">Lengkapi informasi siswa dengan benar</p>
            </div>
            ...
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        @if(isset($siswa))
                            ...
                            <div class="bg-purple-50 p-4 rounded-lg border border-purple-200">
                                ...
                                <p class="mt-2 text-xs text-gray-500 flex items-center gap-1">
                                    ...
                                    User account tidak dapat diubah setelah siswa dibuat
                                </p>
                            </div>
                        @else
                            <div>
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Kelas -->
                        <div>
                            <label for="kelas_id" class="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
                            ...
                            <div class="relative">
                                ...
                                <i data-feather="home" class="absolute left-3 top-3.5 w-4 h-4 text-gray-400"></i>
                            </div>
                        </div>
