    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mt-6 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <form id="form-hapus-siswa" action="{{ route('admin.siswa.destroy', $siswa->id) }}" method="POST" class="inline">
                ...
                <button type="button"
                    onclick="hapusSiswaConfirm()"
                    class="bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white px-8 py-3 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
