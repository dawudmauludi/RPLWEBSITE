    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-lg border border-purple-100 p-6 mb-6">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">{{ isset($kaprodi) ? 'Edit kaprodi' : 'Tambah kaprodi' }}</h1>
                    <p class="text-gray-600 text-sm">{{ isset($kaprodi) ? 'Perbarui informasi kaprodi' : 'Buat kaprodi baru untuk dipublikasikan' }}</p>
                </div>
            </div>
        </div>
        <div class="grid gap-6">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-purple-100 p-6">
                ...
                <div class="grid gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text"
                               name="name"
                               placeholder="Masukkan name kaprodi..."
                               value="{{ old('name', $kaprodi->name ?? '') }}"
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('slogan', $kaprodi->slogan ?? '') }}"
                               class="w-full px-4 py-3 border border-purple-200 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-purple-100 p-6">
                <div class="flex items-center mb-6">
                    ...
                    <h2 class="text-lg font-semibold text-gray-800">Konten kaprodi</h2>
                </div>
                ...
                <div class="grid gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input id="description" type="hidden" name="description" value="{{ old('description', $kaprodi->description ?? '') }}">
                        <trix-editor input="description"
                                    placeholder="Tulis description kaprodi lengkap di sini..."
            ...
            <div class="flex justify-between items-center mt-4">
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded shadow-md transition-all">
                     <span>{{ isset($kaprodi) ? 'Update Data' : 'Simpan Data' }}</span>
                </button>
                ...
                <a href="{{ route('admin.kaprodi.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-6 rounded shadow-sm transition-all">
                    Kembali
                </a>
            </div>
        </div>
