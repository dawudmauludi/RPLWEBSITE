        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6 border-l-4 border-purple-500">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-center space-x-3 mb-4 md:mb-0">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-800">Data lesson</h1>
                        <p class="text-gray-600 mt-1">Kelola data lesson dengan sistem</p>
                    </div>
                </div>
                <div class="flex flex-col sm:flex-row sm:items-center gap-3 w-full md:w-auto">
                    <form method="GET" action="{{ route('admin.lesson.index') }}" id="searchForm" autocomplete="off" class="w-full sm:w-auto">
                        <div class="relative">
                ...
                <div class="overflow-x-auto">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-purple-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-600 font-mono">{{ $lesson->name }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center space-x-2">
                                        <img src="{{ $lesson->image ? url('storage/' . $lesson->image) : asset('images/no-image.png') }}"
                                             alt="{{ $lesson->name }}"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <form action="{{ route('admin.lesson.destroy', $lesson->id) }}" method="POST" class="inline delete-user-form">
                                            @csrf @method('DELETE')
                                            <button type="button"
                    ...
                    <div class="text-center py-12">
                        <div class="flex flex-col items-center">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">Tidak ada data lesson</h3>
                            <p class="text-gray-600 mb-4">Belum ada lesson yang terdaftar dalam sistem</p>
                            <a href="{{ route('admin.lesson.create') }}"
                               class="inline-flex items-center space-x-2 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200">
                                ...
                                <span>Tambah lesson Pertama</span>
                            </a>
                        </div>
                    </div>
                    @endif
