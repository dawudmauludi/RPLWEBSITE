...
<div class="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50">
    <div class="container mx-auto p-6">
        <div class="bg-white rounded-xl shadow-lg border border-purple-100 p-6 mb-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Kelola dan publikasikan berita terbaru</p>
                    </div>
                </div>
            ...
            <form method="GET" action="{{ route('admin.berita.index') }}" class="flex flex-col sm:flex-row gap-4 mt-4">
                            ...
                            <tr class="hover:bg-purple-50 transition-colors duration-200">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">{{ Str::limit($berita->judul, 30) }}</div>
                                            <div class="text-sm text-gray-500">{{ \Carbon\Carbon::parse($berita->created_at)->format('d M Y') ?? 'Tanggal tidak tersedia' }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <form action="{{ route('admin.berita.destroy', $berita) }}" method="POST" class="inline" onsubmit="return confirmDelete(event)">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                            ...
                            <tr>
                                <td colspan="3" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 mb-4">Belum ada berita yang ditambahkan. Mulai tambahkan berita pertama Anda!</p>
                                        <a href="{{ route('admin.berita.create') }}"
