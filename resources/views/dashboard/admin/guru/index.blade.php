            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-center space-x-3 mb-4 md:mb-0">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Kelola data guru di sistem</p>
                    </div>
                </div>
                <div class="flex flex-col sm:flex-row sm:items-center gap-3 w-full md:w-auto">
                    <form method="GET" action="{{ route('admin.guru.index') }}" id="searchForm" autocomplete="off" class="w-full sm:w-auto">
                        <div class="relative">
                            ...
                            <input type="text"
                                ...
                                placeholder="Cari berdasarkan nama, NIP, atau telepon..."
                ...
                <div class="overflow-x-auto">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-purple-50 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-600 font-mono">{{ $guru->nip }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-semibold text-gray-900">{{ $guru->nama }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center text-sm text-gray-600">
                                        <i data-feather="phone" class="w-4 h-4 mr-2 text-purple-500"></i>
                                        {{ $guru->telepon }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center text-sm text-gray-600">
                                        <i data-feather="calendar" class="w-4 h-4 mr-2 text-purple-500"></i>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <form action="{{ route('admin.guru.destroy', $guru->id) }}" method="POST" class="inline delete-guru-form">
                                            @csrf @method('DELETE')
                                            <button type="button"
                                                    class="inline-flex items-center px-3 py-1.5 bg-red-100 hover:bg-red-200 text-red-700 rounded-lg transition-colors duration-150 delete-guru-btn"
                                                    data-nama="{{ $guru->nama }}"
                                                    title="Hapus Data">
                                        ...
                                        <script>
                                        document.addEventListener('DOMContentLoaded', function() {
                                            document.querySelectorAll('.delete-guru-btn').forEach(function(btn) {
                    ...
                    <div class="text-center py-12">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-600 mb-4">Belum ada guru yang terdaftar dalam sistem</p>
                            <a href="{{ route('admin.guru.create') }}"
...
document.getElementById('searchInput').addEventListener('input', function() {
    ...
    this.delay = setTimeout(() => {
        ...
        fetch(`{{ route('admin.guru.index') }}?search=${encodeURIComponent(searchValue)}`, {
            headers: {
