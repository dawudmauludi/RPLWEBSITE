    ...
    <div class="p-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="space-y-8">
                ...
                <div>
                    <label class="flex items-center text-sm font-semibold text-gray-700 mb-2">
                        <i data-feather="image" class="w-4 h-4 mr-2 text-purple-600"></i>
                    ...
                    <div class="relative">
                        <input type="file"
                            ...
                            accept="image/*"
                            required
                            class="block w-full px-4 py-3 border rounded-lg transition-colors duration-200 focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('image') border-red-500 @enderror">
                    </div>
                ...
                <div>
                    ...
                    <div class="trix-container w-full border rounded-lg bg-gray-50 transition-all duration-200 focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-transparent focus-within:bg-white @error('description') border-red-500 @enderror">
                        <input id="isi" type="hidden" name="isi" value="{{ old('isi', $future->isi ?? '') }}">
