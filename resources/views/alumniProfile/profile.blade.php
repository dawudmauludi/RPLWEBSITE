            ...
            <div class="flex flex-col lg:flex-row items-center lg:items-start space-y-6 lg:space-y-0 lg:space-x-8 relative z-10">
                ...
                <div class="flex-shrink-0">
                    <div class="w-32 h-32 lg:w-40 lg:h-40 rounded-full bg-white/20 backdrop-blur-sm border-4 border-white/30 flex items-center justify-center overflow-hidden shadow-2xl">
                        @if(isset($alumni->foto) && $alumni->foto)
                            <img src="{{ asset('storage/' . $alumni->foto) }}" alt="Foto {{ $alumni->nama ?? 'Siswa' }}" class="w-full h-full object-cover">
                        @else
                ...
                <div class="text-center lg:text-left text-white flex-1">
                    <h1 class="text-3xl lg:text-4xl font-bold mb-2">{{ $alumni->nama ?? '' }}</h1>
                    <div class="flex items-center justify-center lg:justify-start space-x-2">
                        <i data-feather="hash" class="w-4 h-4 text-purple-300"></i>
                        <span class="text-purple-300">NISN: {{ $alumni->nisn ?? '1234567890' }}</span>
                    </div>
                    <div class="flex items-center justify-center lg:justify-start space-x-2">
                        <i data-feather="hash" class="w-4 h-4 text-purple-300"></i>
                        <span class="text-purple-300">Tahun Lulus: {{ $alumni->tahun_lulus ?? '1234567890' }}</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-800 font-medium">{{ $alumni->jenkel ?? 'Laki-laki' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-800 font-medium">{{ $alumni->telepon ?? '+62 812-3456-7890' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-800 font-medium">{{ $alumni->agama ?? 'Islam' }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-800 font-medium leading-relaxed">{{ $alumni->alamat ?? 'Jl. Merdeka No. 123, Kota Bandung, Jawa Barat 40123' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-800 font-medium">{{ $alumni->tempat_lahir ?? 'Bandung' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-800 font-medium">
                                {{ isset($alumni->tanggal_lahir) ? \Carbon\Carbon::parse($alumni->tanggal_lahir)->format('d F Y') : '15 Januari 2005' }}
                            </p>
                        </div>
                    </div>
                </div>
...
<div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm hidden z-50 transition-all duration-300">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto transform transition-all duration-300 scale-95 opacity-0" id="modalContent">
            ...
            <!-- Modal Body -->
          <form action="{{ route('alumni.profileAlumni.update', $alumni->id) }}"
            id="editProfileForm"
            class="p-6"
            method="POST"
            enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="nama" id="edit_nama" value="{{ $alumni->nama ?? 'Ahmad Rizki Pratama' }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="nisn" id="edit_nisn" value="{{ $alumni->nisn ?? '1234567890' }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200" required>
                    </div>
                    <!--  -->
                    <div>
                        ...
                        <input type="text" name="tahun_lulus" id="edit_nisn" value="{{ $alumni->tahun_lulus ?? '1234567890' }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200" required>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="jenkel" id="edit_jenkel"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200" required>
                            <option value="Laki-laki" {{ ($alumni->jenkel ?? 'Laki-laki') == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                            <option value="Perempuan" {{ ($alumni->jenkel ?? '') == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="telepon" id="edit_telepon" value="{{ $alumni->telepon ?? '+62 812-3456-7890' }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200" required>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat" id="edit_alamat" rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200" required>{{ $alumni->alamat ?? 'Jl. Merdeka No. 123, Kota Bandung, Jawa Barat 40123' }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="tempat_lahir" id="edit_tempat_lahir" value="{{ $alumni->tempat_lahir ?? 'Bandung' }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir" id="edit_tanggal_lahir"
                               value="{{ isset($alumni->tanggal_lahir) ? \Carbon\Carbon::parse($alumni->tanggal_lahir)->format('Y-m-d') : '2005-01-15' }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200" required>
                    </div>
...
<script>
    ...
    function initMainMap() {
        ...
        @if($alumni->latitude && $alumni->longitude)
            L.marker([{{ $alumni->latitude }}, {{ $alumni->longitude }}])
                .addTo(map)
                .bindPopup("<b>{{ $alumni->nama }}</b><br>{{ $alumni->alamat }}")
                .openPopup();
        @endif
    }
    ...
    function editProfile() {
        ...
        // Atau jika menggunakan modal:
         window.location.href = "{{ route('alumni.profileAlumni.edit', $alumni->id) }}";
        // openEditModal();
    }
