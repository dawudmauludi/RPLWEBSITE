...
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 py-8 px-4 pt-20">
    <div class="max-w-4xl mx-auto">
        <div class="text-center mb-8">
            ...
            <h3 class="text-base font-semibold text-gray-800 mb-2">Lengkapi Data Alumni</h3>
            <p class="text-gray-600">Lengkapi informasi alumni dengan data yang akurat</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-purple-100 overflow-hidden">
            ...
            <form action="{{ route('alumni.alumni_profile.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="tahun_lulus" class="flex items-center text-sm font-semibold text-gray-700 mb-2">
                            <i data-feather="hash" class="w-4 h-4 mr-2 text-purple-600"></i>
                            Tahun Lulus
                        </label>
