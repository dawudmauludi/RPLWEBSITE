...
<div class="hidden lg:block bg-purple-800 text-white h-screen fixed left-0 top-0 w-64 overflow-y-auto pt-16"> <!-- hidden for mobile, lg:block for desktop -->
    ...
    <nav class="flex flex-col space-y-2 px-4">
        ...
        @role('admin')
            ...
            <a href="{{ route('berita.index') }}" class="hover:bg-white hover:text-purple-800 py-2 px-3 rounded transition {{ request()->is('admin/berita*') ? 'bg-white text-purple-800 font-semibold' : '' }}">
                Berita & Artikel
            </a>
        @endrole
